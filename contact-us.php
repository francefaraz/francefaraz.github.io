...
if(isset($_POST['submit'])){
    ...
    $mail->SMTPAuth=true;
    $mail->SMTPSecure='tls';
    $mail->Username='farazrock47@gmail.com';
    $mail->Password='faraz@143';
    $mail->setFrom($_POST['email'],$_POST['name']);
    $mail->addAddress('farazrock47@gmail.com');
    $mail->addReplyTo($_POST['email'],$_POST['name']);
    $mail->isHTML(true);
    $mail->Subject='Complient Submission: '.$_POST['subject'];
    $mail->Body='<h1 align=center>Name :'.$_POST['name'].'<br>email :'.$_POST['email'].'Message :'.$_POST['msg'].'</h1>';
    
    if(!$mail->send()) {
   $res = 'Message could not be sent.
   Mailer Error: ' . $mail->ErrorInfo;
} else {
   $res='Message has been sent Successfull Thanks For Contacting US';
}
...
<li style="float:left">>  <a href="index.html">Back</a></li>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-4 mt-5 bg-light rounded">
        ...
        <hr class="bg-light">
        <h5 class="text-center text-success"><?= $res; ?></h5>
